...
public final class ControlMessage {
    ...
    public static ControlMessage createInjectKeycode(int action, int keycode, int repeat, int metaState) {
        ...
        Ln.i("createInjectKeycode + "+msg.type+" " +
                "action:"+msg.action+" " +
                "keycode:"+msg.keycode+" " +
                "repeat:"+msg.repeat+" " +
                "metaState:"+msg.metaState+" "
        );
        return msg;
    }
    ...
    public static ControlMessage createInjectText(String text) {
        ...
        Ln.i("createInjectText + "+msg.type+" " +
                "action:"+msg.action+" " +
                "text:"+msg.text
        );
        return msg;
    ...
    public static ControlMessage createInjectTouchEvent(int action, long pointerId, Position position, float pressure, int actionButton,
        ...
        msg.buttons = buttons;
        Ln.i("createInjectTouchEvent + "+msg.type+" " +
                "action:"+msg.action+" " +
    ...
    public static ControlMessage createInjectScrollEvent(Position position, float hScroll, float vScroll, int buttons) {
        ...
        msg.vScroll = vScroll;
        msg.buttons = buttons;
        Ln.i("createInjectScrollEvent + "+msg.type+" " +
                "position:"+msg.position+" " +
                "hScroll:"+msg.hScroll+" " +
                "vScroll:"+msg.vScroll+" " +
                "buttons:"+msg.buttons+" "
    ...
    public static ControlMessage createSetDisplayPower(boolean on) {
        ...
        msg.on = on;
        Ln.i("createSetDisplayPower + "+msg.type+" " +
                "on:"+msg.on
        );
        return msg;
    }
    ...
    public static ControlMessage createUhidCreate(int id, int vendorId, int productId, String name, byte[] reportDesc) {
        ...
        msg.text = name;
        msg.data = reportDesc;
        Ln.i("createUhidCreate + "+msg.type+" " +
                "id:"+msg.id + " " +
                "vendorId:"+msg.vendorId + " " +
                "productId:"+msg.productId + " " +
                "text:"+msg.text + " " +
                "data:"+ Arrays.toString(msg.data)
        );
        return msg;
    }
