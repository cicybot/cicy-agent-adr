...
public class SurfaceVideoEncoder implements AsyncProcessor {
    ...
    private final StreamerVideo streamer;
    ...
    public SurfaceVideoEncoder(SurfaceCapture capture, StreamerVideo streamer, Options options) {
...
//                }
    ...
    private void encode(MediaCodec codec, StreamerVideo streamer) throws IOException {
    ...
    public void setHasClients(boolean b) {
        this.hasClients = b;
    }
}
